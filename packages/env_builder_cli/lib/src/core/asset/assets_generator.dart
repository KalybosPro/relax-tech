...
class AssetsGenerator {
  ...
  Future<String> generate() async {
    ...
    CliLogger.debug(
      'Processing ${sortedAssets.length} assets (sorted by size)',
    );
    ...
    buffer.writeln(
      '// This file is automatically generated by env_builder_cli',
    );
  ...
  Future<EncryptedAsset> _processAsset(asset_reader.AssetFile asset) async {
    ...
    if (asset.type == asset_reader.AssetType.svg) {
      ...
      if (svgMinify) {
        ...
        final cacheKey =
            'svg_minify_${asset.path.hashCode}_${svgContent.hashCode}';
  ...
  Future<List<int>> _readAssetBytesStreaming(
    asset_reader.AssetFile asset,
  ) async {
    final file = File(asset.path);
    final bytes = <int>[];
